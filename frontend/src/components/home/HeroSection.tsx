...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[45vh] md:min-h-[50vh] flex items-center justify-center overflow-hidden mt-[45px] md:mt-[55px]">
      {/* Background Image */}
      ...
      <div className="relative container-custom py-12 md:py-12 px-6 md:px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="mt-12 mb-20 flex gap-8 md:gap-12 justify-center"
          >
            <div>
